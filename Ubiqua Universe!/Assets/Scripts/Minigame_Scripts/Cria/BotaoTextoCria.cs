...
public class BotaoTextoCria : MonoBehaviour
{
    public Button[] buttons;
    public Text[] buttonTexts;
    public VariableHandlerCria variableHandler;  // Referência para o script VariableHandler
    public GameControllerCria gameController;

    private int[] indices;
    private dadosRespostasasCria[] respostaAtual;  // Array para armazenar a resposta atual
