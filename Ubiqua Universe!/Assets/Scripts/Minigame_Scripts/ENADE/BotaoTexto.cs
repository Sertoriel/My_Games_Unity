...
public class BotaoTexto : MonoBehaviour
{
    ...
    public VariableHandler variableHandler;  // Referência para o script VariableHandler
    public GameController gameController;

    private int[] indices;
    private dadosRespostasas[] respostaAtual;  // Array para armazenar a resposta atual
