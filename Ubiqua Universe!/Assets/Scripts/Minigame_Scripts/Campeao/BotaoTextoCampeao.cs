...
public class BotaoTextoCampeao : MonoBehaviour
{
    public Button[] buttons;
    public Text[] buttonTexts;
    public VariableHandlerCampeao variableHandler;  // Referência para o script VariableHandler
    public GameControllerCampeao gameController;

    private int[] indices;
    private dadosRespostasasCamp[] respostaAtual;  // Array para armazenar a resposta atual
