...
public class BotaoTextoOsg : MonoBehaviour
{
    public Button[] buttons;
    public Text[] buttonTexts;
    public VariableHandlerOsg variableHandler;  // Referência para o script VariableHandler
    public GameControllerOsg gameController;

    private int[] indices;
    private dadosRespostasasOsg[] respostaAtual;  // Array para armazenar a resposta atual
