...
public class BotaoTextoExperience : MonoBehaviour
{
    public Button[] buttons;
    public Text[] buttonTexts;
    public VariableHandlerExp variableHandler;  // Referência para o script VariableHandler
    public GameControllerExperience gameController;

    private int[] indices;
    private dadosRespostasasExp[] respostaAtual;  // Array para armazenar a resposta atual
