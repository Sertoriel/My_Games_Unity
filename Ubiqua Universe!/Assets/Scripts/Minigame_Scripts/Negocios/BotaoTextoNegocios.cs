...
public class BotaoTextoNegocios : MonoBehaviour
{
    public Button[] buttons;
    public Text[] buttonTexts;
    public VariableHandlerNeg variableHandler;  // Referência para o script VariableHandler
    public GameControllerNegocios gameController;

    private int[] indices;
    private dadosRespostasasNeg[] respostaAtual;  // Array para armazenar a resposta atual
