...
// CONTROLE DE PULO tOUCH.
        ...
        if (GameControler.score == 80 && WonlevelC == 0)
        {
            WonlevelC +=1;
            Quiz_Controllers.GoQuiz = true;
            Quiz_Controllers.QuizSequance +=1;
            StartCoroutine (Wonlevel());
            

        }else if (GameControler.score == 140 && WonlevelC == 1)
        {
        ...
        }else if (GameControler.score == 210 && WonlevelC == 2)
        {
            WonlevelC +=1;
            Quiz_Controllers.GoQuiz = true;
            Quiz_Controllers.QuizSequance +=1;
        ...
        }else if (GameControler.score == 270 && WonlevelC == 3)
        {
        ...
        }else if (GameControler.score == 340 && WonlevelC == 4)
        {
        ...
        }else if (GameControler.score == 410 && WonlevelC == 5)
        {
