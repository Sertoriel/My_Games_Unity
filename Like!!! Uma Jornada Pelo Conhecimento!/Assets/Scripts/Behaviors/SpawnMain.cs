...
public class SpawnMain : MonoBehaviour
{
    ...
    private IEnumerator SpawnObstacle()
    {
        while (true)
        {
            ...
            else if(!GameControler.gameOver && GameControler.score == 160f) CreateBoss();
            else if(!GameControler.gameOver && GameControler.score == 240f) CreateBoss();
            else if(!GameControler.gameOver && GameControler.score == 320f) CreateBoss();
        }
    }
